...
- Dokumentaatio React-komponenttina: `src/features/app/docs/DocumentationPage.jsx`
- Markdown-lahde: `public/docs/FEATURE_MAP.md`
...
| API-dokumentaatio            | ` http://localhost:8080/swagger-ui/index.html`                                              |
...
| Ominaisuus                                    | Tiedostot                                                                             |
| --------------------------------------------- | ------------------------------------------------------------------------------------- |
| Bike-kuvien tallennushakemisto (runtime-data) | `../backend/images/theft-reports/*`                                                   |
