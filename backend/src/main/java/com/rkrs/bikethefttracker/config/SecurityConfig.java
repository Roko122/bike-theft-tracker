    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtFilter jwtFilter, RequestLoggingFilter requestLoggingFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests((auth) -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/images/theft-reports/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/theft-reports/{id}").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/theft-reports/{id}/status").authenticated()
